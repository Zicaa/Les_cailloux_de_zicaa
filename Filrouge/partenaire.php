...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/responsive_index.css" media="only screen and (max-width:800px)"></link>
    </head>
    <body>
            ...
            <aside>
                <nav class="liens">
                    <ul>
                        ...
                        <li><input type="search" id="site-search" aria-label="Search through site content" placeholder="rechercher"></input></li>
        ...
        <section>
            <article>
                ...
                <img src="https://www.pole-emploi.fr/files/live/sites/PE/files/nouveau%20site/candidat/service-en-ligne/Emploi-store-logo-308.gif"alt="image article"/></img>
                <img src="https://www.adrar-formation.com/sites/all/themes/adrar/logo.png"alt="image article"/></img>
                <img src="https://languedoc-roussillon-universites.fr/images/img/Actus-img/2019/actu-Region-Occitanie-thumb.jpg"alt="image article"/></img>
            </article>
        </section>         
        <footer>
            <nav>
